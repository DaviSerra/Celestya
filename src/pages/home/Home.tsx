...
export default function Home() {
  return (
    <div
      className="min-h-screen py-10 md:py-0 lg:py-10 bg-center overflow-hidden bg-cover lg:bg-[url('/src/assets/design/background-home.png')] bg-[url('/src/assets/design/background-tablet.png')] bg-no-repeat">
      <div className="flex flex-col lg:flex-row lg:justify-between items-center lg:items-end h-[vh] lg:h-[61vh] px-6 md:px-20 lg:px-36 md:mt-28 pt-16">
        <div className="flex flex-col space-y-3 md:space-y-6 text-center lg:text-left mb-10 lg:mb-0">
          ...
          <div className="max-w-full md:max-w-[500px] lg:max-w-[700px]">
            <p className="text-sm md:text-1xl text-[var(--blue-secondary)] font-barlow-condensed">Vamos encarar; se você quer ir para o espaço, você pode muito bem ir genuinamente para o espaço sideral e não ficar pairando na borda dele.
        ...
        <div className="group self-center lg:self-end">
          <Link to="/destino" className="w-full">
            <div className="relative w-[150px] h-[150px] md:w-[220px] md:h-[220px] lg:w-[272px]  lg:h-[272px] cursor-pointer">
