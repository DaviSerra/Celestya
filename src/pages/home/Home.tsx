...
const Home: React.FC = () => {
  return (
    <div
      className="min-h-screen w-screen py-10 md:py-0 lg:py-10 bg-center overflow-hidden bg-cover lg:bg-[url('/design/background-home.png')] bg-[url('/design/background-tablet.png')] bg-no-repeat">
      <div className="flex flex-col lg:flex-row lg:justify-between items-center lg:items-end lg:h-[60vh] px-6 md:px-20 lg:px-36 md:mt-28 pt-28 lg:pt-0 md:pt-0">
        <div className="flex flex-col space-y-3 md:space-y-6 text-center lg:text-left mb-10 lg:mb-0">
          <h1 className="font-barlow-condensed text-lg md:text-2xl text-blue-secondary uppercase tracking-1">Então... você quer explorar o</h1>
          ...
          <div className="max-w-full md:max-w-[500px] lg:max-w-[700px]">
            <p className="text-sm md:text-lg text-blue-secondary font-barlow-condensed">Vamos encarar; se você quer ir para o espaço, você pode muito bem ir genuinamente para o espaço sideral e não ficar pairando na borda dele.
        ...
        <div className="group self-center lg:self-end">
          <Link to="/destino" className="w-full">
            <div className="relative w-[150px] h-[150px] md:w-[272px] top- lg:top-0 md:top-0 md:h-[272px] md:mt-10 lg:w-[272px] lg:h-[272px] cursor-pointer">
              ...
              <nav className="flex justify-center items-center bg-white rounded-full w-full h-full">
                <h1 className="text-xl md:text-2xl lg:text-3xl uppercase text-blue-primary font-bellefair">Explorar</h1>
              </nav>
            </div>
          </Link>
        </div>
