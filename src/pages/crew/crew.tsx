...
const Crew: React.FC = () => {
    ...
    return (
        <div className="min-h-screen text-white pt-28 sm:pt-20 md:pt-30 lg:pt-40 w-full overflow-hidden bg-center bg-cover bg-[url('/design/background-crew.png')] bg-no-repeat">
