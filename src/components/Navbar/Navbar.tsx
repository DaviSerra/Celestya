...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex text-white py-10 md:py-0 lg:py-10">
      ...
      {isMobile && isOpen && (
        <div className="fixed inset-0 bg-white/5 backdrop-blur-md left-44 z-40 w-[260px] scale-in-hor-right">
          
          <ul className="flex flex-col items-start p-8 text-white space-y-8 mt-20">
            <li className="cursor-pointer uppercase font-barlow-condensed text-base">
              <NavLink
                to="/"
